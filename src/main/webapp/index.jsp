...
<div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#">KK's DevOps AWS Lab</a>
        </div>
...
<div class="jumbotron">
    <div class="container">
        <h1>Hello</h1>
        <p>This is KK's DevOps AWS Lab</p>
        <p><a class="btn btn-primary btn-lg" role="button">Want more!! &raquo;</a></p>
...
<div class="container">
    ...
    <footer>
        <p>&copy; kk's devops lab 2020-2021</p>
    </footer>
</div> <!-- /container -->
